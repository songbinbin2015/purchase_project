                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <?php if($item['status'] != 1): ?>
                                    <a href="<?php echo e(route('purchases.status',['status'=>1,'id'=>$item['id']])); ?>"><button class="btn btn-info btn-xs" type="button"><i class="fa fa-warning"></i> 恢复上架</button></a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('purchases.status',['status'=>2,'id'=>$item['id']])); ?>"><button class="btn btn-warning btn-xs" type="button"><i class="fa fa-warning"></i> 禁用</button></a>
                                <?php endif; ?>
                                <a href="<?php echo e(route('purchases.delete',$item['id'])); ?>"><button class="btn btn-danger btn-xs" type="button"><i class="fa fa-trash-o"></i> 删除</button></a>
                            </div>
                        </td>
                    </tr>
