...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="ibox-content">
            ...
            <form class="form-horizontal m-t-md" action="{{route('categorys.update',$catagory->id)}}" method="POST">
                    ...
                    <div class="col-sm-2">
                        <select name="parent_id" class="form-control">
                            ...
                            @foreach($treer as $k=>$item)
                                <option value="{{$item['id']}}" @if($catagory->parent_id == $item['id']) selected="selected"@endif >{{$item['_name']}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="name" value="{{$catagory->name}}" class="form-control" required data-msg-required="请输入名称">
                        @if ($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="path" value="{{$catagory->path}}" class="form-control">
                        @if ($errors->has('path'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <input type="text" name="code" value="{{$catagory->code ? $catagory->code : 255 }}" required class="form-control">
                        @if ($errors->has('code'))
